...
if (isset($items) && count($items) > 0) {
    ...
    <template id="address-template">
        <style>
            ...
            button {
                ...
                font-size: 24px;
                /* Adjust this value to make the minus symbol larger */
                padding: 10px;
            ...
            button::before {
                ...
                color: red;
                /* Optional: Change color of the symbol */
                position: absolute;
                /* left: 50%;;  */
                top: 50%;
    ...
    <template id="personal-template">
        ...
        <div id="user-info">
            ...
            <b>
                <slot name="FirstName">Unknown First Name</slot>
            </b>
            ...
            <b>
                <slot name="LastName">Unknown Last Name</slot>
            </b>
            ...
            <b>
                <slot name="Password">Unknown Password</slot>
            </b>
            ...
            <ul id="option_container">
                ...
                <li>
                    <button class="option" id="button_address">Address
                        <svg viewBox="0 0 24 24" class="option_icon" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path
                ...
                <li>
                    <button class="option" id="button_billing">Billing
                        <svg class="option_icon" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" stroke-width="3"
                            ...
                            <g id="SVGRepo_iconCarrier">
                                ...
                                <line x1="19.42" y1="43.04" x2="46.02" y2="43.04" stroke-linecap="round"></line>
                                <line x1="19.42" y1="49.29" x2="46.02" y2="49.29" stroke-linecap="round"></line>
                                <path
                                    d="M37.54,33.86H28c-.06,0-.1-.08-.06-.12.66-.7,3.79-4.29,2.59-7.51-1.33-3.59-.47-9.3,6-6.65"
                                    stroke-linecap="round"></path>
                                <line x1="26.46" y1="26.32" x2="35.39" y2="26.32" stroke-linecap="round"></line>
                            </g>
                        </svg>
                    </button>
                </li>
                ...
                <li>
                    <button class="option" id="button_history">History
                        <svg class="option_icon" height="21px" version="1.1" viewBox="0 0 20 21" width="20px"
                ...
                <li>
                    <button class="option" id="admin_index_button">Admin Hub
                        <object class="option_icon admin_icon" type="image/svg+xml"
                            data="{{asset("/images/setting_images/admin.svg")}}"></object>
                    </button>
                </li>
                {{-- <li>
